...
public class BiodataDesigner extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fkampus = new javax.swing.JTextField();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(fnama)
                                    .addComponent(fkampus)
                                    .addComponent(fipk, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(nilai3, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                                    .addComponent(nilai2)
                                    .addComponent(nilai1))))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(fkampus, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String kampus = fkampus.getText();
        String ipk = fipk.getText();
        String snilai1 = nilai1.getText();
        String snilai2 = nilai2.getText();
        String snilai3 = nilai3.getText();
        double vnilai1 = 0, vnilai2 = 0, vnilai3 = 0;
        try {
            vnilai1 = Double.parseDouble(snilai1);
            vnilai2 = Double.parseDouble(snilai2);
            vnilai3 = Double.parseDouble(snilai3);
        } catch (NumberFormatException errror) {
            //errorHandling
        }
        HitungNilai hitung = new HitungNilai(vnilai1, vnilai2, vnilai3);
        hitung.HitungDesigner();
        new HasilPenilaian(nama, kampus, ipk, hitung.GetNilai()).setVisible(true);
        dispose();
    ...
    private javax.swing.JTextField fkampus;
