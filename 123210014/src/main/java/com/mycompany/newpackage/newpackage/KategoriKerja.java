 ...
 */
public class KategoriKerja extends javax.swing.JFrame {

    /**
     * Creates new form KategoriKerja
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KategoriKerja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
